...
public class Prix {
    ...
    private static final int NB_CHIFFRE_APRES_VIRGULE_EN_EURO = 2;
    private static final double CENT = Math.pow(10, NB_CHIFFRE_APRES_VIRGULE_EN_EURO);
    ...
    Prix applique(TauxReduction taux) {
